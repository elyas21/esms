...
const School = require('../controllers/manageSchool');
const Director = require('../controllers/manageDirector');
const Student = require('../controllers/manageStudent');
const Course = require('../controllers/manageCourse');
const Grade = require('../controllers/manageGrade');
const Section = require('../controllers/manageSection');
...
const CourseGradeing = require('../controllers/manageCouresGrade');
const ClassYear = require('../controllers/manageClassYear');
const Semister = require('../controllers/manageSemisterMap');
